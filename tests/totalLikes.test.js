...
describe('total likes', () => {
  test('empty lists equal to zero', () => {
  ...
  test('when list has more than one blog, sums the likes', () => {
...
describe('favorite blog', () => {
  ...
  test('when list has more than one blog, finds the most popular', () => {
...
describe('prolific author', () => {
  ...
  test('when list has only one blog, displays only the actor and the publication', () => {
  ...
  test('when list has more than one blog, finds the most prolific author', () => {
